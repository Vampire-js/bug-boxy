...
export class TestLevel2{
    ...
    constructor(c:CanvasRenderingContext2D | null , x:number, y:number){
        ...
        this.wall3 = new Wall(this.origin.x - this.width/2,this.origin.y - this.height/2,this.origin.x + this.width/2 - 50,this.origin.y - this.height/2 -50, -Math.PI/2,c)
        ...
        this.wall5 = new Wall(this.origin.x -150 , this.origin.y + 50 , this.origin.x + 140 , this.origin.y-10 ,0,c)

        this.walls = [this.wall1 , this.wall2 ,  this.wall3 , this.wall4, this.wall5]
